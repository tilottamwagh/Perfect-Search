...
contextBridge.exposeInMainWorld('perfectsearch', {
    ...
    usageSummary: (opts) => ipcRenderer.invoke('usage:summary', opts || {}),
    usagePerThread: (threadId) => ipcRenderer.invoke('usage:perThread', { threadId }),
    usageSetPricing: (pricing) => ipcRenderer.invoke('usage:setPricing', { pricing }),
